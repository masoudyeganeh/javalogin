            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-md-8">
                        <form action="/verifyCode.do" method="post" class="bg-white rounded shadow-5-strong p-5">
                            <!-- Email input -->
                            <div class="form-outline mb-4" data-mdb-input-init>
                                <input type="number" name="otp" class="form-control" />
                                <label class="form-label">Enter the code in the message sent to your phone</label>
                            </div>
