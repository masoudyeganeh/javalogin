            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-md-8">
                        <form action="/register.do" method="post" class="bg-white rounded shadow-5-strong p-5">
                            <!-- Email input -->
                            ...
                            <!-- Submit button -->
                            <input type="submit" class="btn btn-primary btn-block" data-mdb-ripple-init value="sign in">
                        </form>
                    </div>
                </div>
            </div>
